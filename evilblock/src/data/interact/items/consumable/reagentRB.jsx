...
export const reagentRB = {
    id: consumableConstants.REAGENT_RB,
    combineId: consumableConstants.REAGENT_RB,
    name: "Reagent RB",
    type: ITEM,
    ...
    combine: generateComboGraph()[consumableConstants.REAGENT_RB],
    isCollected: false
};
